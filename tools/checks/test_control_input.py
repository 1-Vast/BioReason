...
# With control_input_mode="control_mean", input is the train control mean
# Verify it's not the original cell expression
assert not np.allclose(item["x"].numpy(), X[3]), "Non-control should not use own expression"
