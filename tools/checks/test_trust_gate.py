...
# 鈹€鈹€ 1) EvidenceGate confidence with return_score 鈹€鈹€
...
# 2) EvidenceGate without return_score 鈫?just z
...
print("  3) EvidenceGate evidence=None 鈫?trust=None OK")

# 鈹€鈹€ 4) BioReason with evidence 鈫?trust present 鈹€鈹€
...
# 鈹€鈹€ 5) BioReason without evidence 鈫?trust is None 鈹€鈹€
out5 = m(x, pert, evidence=None)
assert "trust" in out5, "trust key should exist"
# trust is None when evidence is None (trust_all is empty 鈫?None)
assert out5["trust"] is None, f"trust should be None, got {out5['trust']}"
print("  5) BioReason evidence=None 鈫?trust=None OK")

# 鈹€鈹€ 6) BioReason with evidence_dim but use_evidence_conf=False still returns trust 鈹€鈹€
...
# 鈹€鈹€ 7) Reasoner return_trust 鈹€鈹€
...
# 鈹€鈹€ 8) Reasoner return_trust=False 鈫?just z 鈹€鈹€
