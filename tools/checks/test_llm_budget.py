...
assert audit.loc[audit["pert"] == "C_KO", "filtered_reason"].item() == "llm_call_limit"
assert bool(audit.loc[audit["pert"] == "C_KO", "used_evidence"].item()) is False
...
assert set(miss["filtered_reason"]) == {"dry_run"}
